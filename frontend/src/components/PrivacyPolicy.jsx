    ...
    <div className="policy-page">
      <div className="container">
        ...
        <div className="policy-content">
          ...
          <p>
            At Fabnix (https://fabnix.luisant.cloud), we value the trust you
            place in us. This Privacy Policy explains how we collect, use,
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                Payment details (processed securely by our payment partners)
              </li>
              <li>Order history & preferences</li>
              <li>
                Device information, IP address, cookies, browsing behaviour
              </li>
              <li>
                Any information you submit through forms or customer support
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2>4. Cookies</h2>
            <p>
              We use cookies to improve browsing experience, analyze traffic,
