    ...
    <div className="policy-page">
      <div className="container">
        ...
        <div className="policy-content">
          ...
          <p>
            Welcome to Fabnix (https://fabnix.luisant.cloud). By using our
          ...
          <section>
            ...
            <ul>
              <li>
                You must not misuse the website for fraud or illegal activities.
              </li>
              <li>
                All content, images, and designs belong to Fabnix and cannot be
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                Orders may be cancelled if payment fails or for any suspicious
                activity.
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2>5. Liability</h2>
            <p>Fabnix is not responsible for:</p>
            <ul>
