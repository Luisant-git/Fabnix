            ...
            <div className="app-container">
              ...
              <main className="main-content">
                <Routes>
                  ...
                  />
                  <Route
                    path="/subcategory/:subcategorySlug/:subcategoryId"
                    element={<CategoryPage />}
                  />
                  <Route
                    ...
                    <div className="whatsapp-modal-body">
                      <div className="whatsapp-message">
                        ...
                        <div className="whatsapp-bubble">
                          <strong>Fabnix</strong>
                          <p>Hello! 👋 I'm from Fabnix, How can I help you?</p>
                    ...
                    <div className="whatsapp-modal-footer">
                      <input
                        ...
                        onKeyPress={(e) =>
                          e.key === "Enter" &&
                          window.open(
                            `https://wa.me/919597689888?text=${encodeURIComponent(
                              whatsappMessage
                            )}`,
                            "_blank"
                          )
